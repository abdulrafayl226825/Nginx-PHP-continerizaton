...
turn:
    enabled: true
    domain: livekit-turn.livekit-agent.duckdns.org
    tls_port: 5349
    udp_port: 3478
    external_tls: true
keys:
    API9d8ZmEvCawcL: zXNZNndMbHgNWh6DZ0n7UZGKFEZitpnkaxXFfoFSPiV
...
apps:
  tls:
    certificates:
      automate:
        - livekit.livekit-agent.duckdns.org
        - livekit-turn.livekit-agent.duckdns.org
  layer4:
    servers:
      main:
        listen: [":443"]
